    ...
    <div className='back'>
      ...
      <Container>
        <center>
          <br />
          <br />
          <Typography variant="body1"><b>Please update your details carefully</b></Typography>
          <br />
          <form onSubmit={submitHandler}>
            ...
            {/* Submit button */}
            <br /><Button type="submit" variant="contained" color="secondary">Update Profile</Button>
          </form><br />
          <Typography>
            <Link to="/dashboard">Return without changing anything.</Link>
          </Typography>
          <br />
          <br />
        </center>
      </Container>
      {/* Redirect to dashboard page after successful profile update */}
      {x === 1 ? <Navigate to="/dashboard" /> : null}
    </div>
  )
}
